    ...
    return (
      <Host>
        ...
        <ion-grid>
          ...
          <ion-row>
            <ion-button shape="round" id="load" color="dark" onClick={() => this.openFunctions()}>Browse API calls  <ion-icon slot="end" name="arrow-forward-outline"></ion-icon></ion-button>
          </ion-row>
          <ion-row>
