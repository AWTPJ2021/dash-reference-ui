    ...
    switch (event.detail.type) {
      ...
      case 'function':
        if(!this.player) {
          ...
          var returnValue = Array.isArray(event.detail.param) ? this.player[event.detail.name].apply(this, event.detail.param) : this.player[event.detail.name](event.detail.param);
          var toSend = {
